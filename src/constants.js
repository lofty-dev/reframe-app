...
export const ANNOUNCEMENTS = [
  { date: "2026/07/06", content: "【不具合のお知らせ】7月6日 10:00頃〜10:30頃の間、Bridge Session中にセッションメモを伝えたいことメモへ紐付けた場合、「言われたこと」欄に内容が保存されない不具合がありました。現在は修正済みです。該当の時間帯にBridge Sessionをご利用になり、記録が見当たらない場合は、お手数ですが「診察等の記録」の該当カードの編集から手動で入力をお願いいたします。ご迷惑をおかけして申し訳ありません。" },
