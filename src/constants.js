...
export const ANNOUNCEMENTS = [
  { date: "2026/07/06", content: "おくすりメモ機能を追加" },
  { date: "2026/07/06", content: "Bridge Sessionにテーマ機能を追加" },
  { date: "2026/06/28", content: "LINEでのお問い合わせ機能を追加" },
  { date: "2026/06/23", content: "ストレス記録・コーピングリストのPDF出力に対応" },
  { date: "2026/06/19", content: "アプリが正しく開けない場合の不具合を修正" },
